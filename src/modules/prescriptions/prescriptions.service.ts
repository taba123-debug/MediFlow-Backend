...
export class PrescriptionsService {
  ...
  async update(id: string, dto: UpdatePrescriptionDto, user: AuthUser) {
    ...
    if (
      ...
      (!doctorProfile || doctorProfile.id !== prescription.doctorId)
    ) {
      throw new ForbiddenException(
        'Only the prescribing doctor or admin can update this prescription.',
      );
    }
  ...
  async remove(id: string, user: AuthUser) {
    ...
    if (
      ...
      throw new ForbiddenException(
        'Only the prescribing doctor or admin can delete this prescription.',
      );
    }
